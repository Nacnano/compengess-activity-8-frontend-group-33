...
const showGroupMembers = async () => {
  ...
  member_dropdown.innerHTML = "<option value='0'>-- เลือกผู้ฝากซื้อ --</option>"
  const options = {
    method: 'GET',
    credentials: 'include'
  }
...
const addItem = async () => {
  ...
  fetch('http://127.0.0.1:3000/items', requestOptions).catch(error =>
...
const deleteItem = async item_id => {
  ...
  await fetch(`http://${backendIPAddress}/items/` + item_id, options).catch(
